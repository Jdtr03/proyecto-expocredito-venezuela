...
export default function AboutSection() {
  return (
    <section className="relative overflow-hidden bg-white pt-6 md:pt-10">
        ...
        <div className="relative z-0 grid items-end gap-6 pb-10 md:grid-cols-12 md:gap-8">
          ...
          */}
          <div className="flex flex-col justify-center self-stretch py-4 md:col-span-7">
            {/* Título */}
            <h2 className="mb-4 text-2xl font-extrabold leading-tight tracking-tight text-gray-950 md:text-2xl lg:text-3xl xl:text-4xl">
